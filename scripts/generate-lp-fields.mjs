...
emitFile("sjh-lp-fields.ts", "SJH_LP_FIELDS", [
  ...
  t("sjh-header-cta-label", "ヘッダー · CTA", "header.ctaLabel", false, 4, "ctaUrl"),
  t("sjh-header-cta-label-mobile", "ヘッダー · CTA（SP）", "header.ctaLabelMobile", false, 4, "ctaUrl"),
  t("sjh-sticky-cta-label", "固定CTA · 文言", "stickyCta.label", false, 4, "ctaUrl"),
  ...
  t("sjh-hero-primary-cta-label", "FV · CTA", "hero.primaryCtaLabel", false, 4, "ctaUrl"),
  ...
  t("sjh-mid-cta-label", "中間CTA · ボタン", "midCta.label", false, 4, "ctaUrl"),
  ...
  t("sjh-info-cta-label", "開催情報 · CTA", "info.ctaLabel", false, 4, "ctaUrl"),
  ...
  t("sjh-final-cta-label", "最終CTA · ボタン", "finalCta.ctaLabel", false, 4, "ctaUrl"),
...
emitFile("ss-lp-fields.ts", "SS_LP_FIELDS", [
  ...
  t("ss-header-cta-label", "ヘッダー · CTA", "header.ctaLabel", false, 4, "ctaUrl"),
  sty("ss-sticky-cta-bar", "固定CTA · バー", true),
  t("ss-sticky-cta-label", "固定CTA · 文言", "stickyCta.label", false, 4, "ctaUrl"),
  ...
  t("ss-hero-primary-cta-label", "FV · CTA", "hero.primaryCtaLabel", false, 4, "ctaUrl"),
  ...
  t("ss-solution-cta-label", "ソリューション · CTA", "solution.ctaLabel", false, 4, "ctaUrl"),
  ...
  t("ss-detail-cta-label", "開催情報 · CTA", "detail.ctaLabel", false, 4, "ctaUrl"),
  ...
  t("ss-final-cta-label", "最終CTA · ボタン", "finalCta.ctaLabel", false, 4, "ctaUrl"),
...
emitFile("jsa-lp-fields.ts", "JSA_LP_FIELDS", [
  t("jsa-floating-cta-label", "固定CTA · 文言", "floatingCta.label", false, 4, "ctaUrl"),
  ...
  t("jsa-hero-cta-label", "FV · CTA", "hero.ctaLabel", false, 4, "ctaUrl"),
  ...
  t("jsa-empathy-cta-label", "共感 · CTA", "empathy.ctaLabel", false, 4, "ctaUrl"),
  ...
  t("jsa-schedule-cta-label", "当日の流れ · CTA", "schedule.ctaLabel", false, 4, "ctaUrl"),
  ...
  t("jsa-event-info-cta-label", "開催情報 · CTA", "eventInfo.ctaLabel", false, 4, "ctaUrl"),
  ...
  t("jsa-final-cta-cta-label", "最終CTA · ボタン", "finalCta.ctaLabel", false, 4, "ctaUrl"),
